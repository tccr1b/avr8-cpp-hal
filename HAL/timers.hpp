...
*/
    ...
    public:
        ...
        enum class ClockSource  : uint8_t{
            ExternalAsync = RegBits::Timers::Timer2::ASSR_EXCLK|
                            RegBits::Timers::Timer2::ASSR_AS2,
            ExternalSync  = RegBits::Timers::Timer2::ASSR_EXCLK,
            InternalAsync = RegBits::Timers::Timer2::ASSR_AS2,
            InternalSync  = 0x00,
        };
        enum class InterruptType: uint8_t{
    ...
    public:
        ...
        static void init(Mode mode, 
                         Clock clk = Clock::DividedBy1024, 
                         ClockSource clkSource = ClockSource::InternalSync){
            currentClock = clk;
        };
